...
long double s21_log(double x) {
  ...
  while (s21_fabs((double)ith_term) > S21_EPSILON) {
    long double dividend = inp - s21_exp((double)partial_sum);
    long double divisor = inp + s21_exp((double)partial_sum);
